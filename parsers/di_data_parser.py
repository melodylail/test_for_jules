...
def parse_di_data(filepath):
    ...
    for line in data_lines:
        ...
        values = re.findall(r'(\d+\s*[KMGT]?B/s)', values_str)
...
def main():
    parser = argparse.ArgumentParser(description='Parse the di_data file.')
    parser.add_argument('filepath', help='The path to the di_data file to parse.')
    args = parser.parse_args()

    data = parse_di_data(args.filepath)
