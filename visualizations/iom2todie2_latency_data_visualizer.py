...
def plot_iom2_data(data_chunk, title_prefix, output_dir):
    transaction_types = ['RDBLK', 'RDSIZED', 'WRSIZED', 'DIRTY_VICTIM', 'CLEAN_VICITM']
...
def visualize_iom2todie2_latency_data(json_path, output_dir):
    try:
    ...
    for i, data_chunk in enumerate(data):
        plot_iom2_data(data_chunk, f'{base_filename}_{i}', output_dir)

if __name__ == '__main__':
    visualize_iom2todie2_latency_data('results/iom2todie2_latency_data_parsed.json', 'plots')
